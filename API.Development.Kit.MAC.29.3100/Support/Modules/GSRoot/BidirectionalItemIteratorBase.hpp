...
template <typename Cont, typename Item, typename Type>
struct std::iterator_traits<GS::BidirectionalItemIteratorBase<Cont, Item, Type>> {
...
template <typename Cont, typename Item, typename Type>
struct std::iterator_traits<GS::ConstBidirectionalItemIteratorBase<Cont, Item, Type>> {
	typedef		  bidirectional_iterator_tag			 iterator_category;
