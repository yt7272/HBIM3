...
#ifndef	VACmpResult
	#define	VACmpResult	int CCALL
	typedef	VACmpResult	VACmpFunction (const void*, const void*);
#endif
...
struct TVAManager {
	...
	GSErr		(STDCALL* sort) (DESC *dptr, VACmpFunction *cmpFunc);
	Int32		(STDCALL* search) (const DESC *dptr, const void *data, VACmpFunction *cmpFunc);
...
inline	GSErr	VASort (DESC *dptr, VACmpFunction *cmpFunc)
					{	return  vaManager.sort (dptr, cmpFunc);				}
inline	Int32	VASearch (const DESC *dptr, const void *data, VACmpFunction *cmpFunc)
