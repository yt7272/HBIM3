...
public:
	...
	virtual GSErrCode	WriteXML (const char* tagName, signed char c)								= 0;
	...
	virtual GSErrCode	WriteXMLTextNode (signed char c);
	...
	virtual GSErrCode	WriteXMLAttr (const char* attrName, signed char c)							= 0;
...
public:
	...
	virtual GSErrCode	ReadXML (const char* tagName, signed char& c)				= 0;
	...
	virtual GSErrCode	ReadXMLAttr (const char* attrName, signed char& c)				= 0;
...
inline GSErrCode	ReadXML (GS::XMLIChannel& ic, const char* tagName, signed char& c)		{ return ic.ReadXML (tagName, c); }
...
GSErrCode	ReadArrayXML (GS::XMLIChannel& ix, EnumerableType& enumerableType, const char* mainTagName,
						  const FunctionRef<GSErrCode (GS::XMLIChannel&, Type&)> reader)
{
...
GSErrCode ReadHashTableXML (GS::XMLIChannel& ix, GS::HashTable<KeyType, ValueType>& table, const char* mainTagName, const char* entryTagName,
						const FunctionRef<GSErrCode (GS::XMLIChannel&, KeyType&, ValueType&)> reader)
{
	ix.ReadStartElement (mainTagName);
...
inline GSErrCode	WriteXML (GS::XMLOChannel& oc, const char* tagName, signed char c)		{ return oc.WriteXML (tagName, c); }
...
static GSErrCode WriteArrayXML (GS::XMLOChannel& ox, const EnumerableType& enumerableType, const char* mainTagName,
								const FunctionRef<GSErrCode (GS::XMLOChannel&, const Type&)> writer)
{
...
GSErrCode WriteHashTableXML (GS::XMLOChannel& ox, const GS::HashTable<KeyType, ValueType>& table, const char* mainTagName, const char* entryTagName,
							const FunctionRef<GSErrCode (GS::XMLOChannel&, const KeyType&, const ValueType&)> writer)
{
	ox.WriteStartElement (mainTagName);
