...
GS_FORCE_INLINE void	Append (FastLogger::LogComposer& logComposer, std::string_view string);
...
GS_FORCE_INLINE void	GS::Append (FastLogger::LogComposer& logComposer, std::string_view string)
{
	logComposer.Append (string);
}
