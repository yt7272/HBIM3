...
typedef int (*VICompareFunction)(void const*, void const*);
...
private:
	...
	short					GetItemTypePriority (short itemType);
...
public:
	...
	GSErrCode SetSorting (VICompareFunction cmpFunction, bool setItemPriority = true);
...
public:
	...
	GSErrCode		SetSorting (const GS::FunctionRef<bool (const SortRecord&, const SortRecord&)> cmpFunction);
};


class VI_DLL_CLASS_EXPORT ProfileVectorImageIterator : public VectorImageIterator
{
public:
	explicit ProfileVectorImageIterator (ProfileVectorImage& profileImage);
};


class VI_DLL_CLASS_EXPORT ConstProfileVectorImageIterator : public ConstVectorImageIterator
{
public:
	explicit ConstProfileVectorImageIterator (const ProfileVectorImage& profileImage);
};
