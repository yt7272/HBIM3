...
VI_DLL_EXPORT
//bool	CmpForHatchesFirst (const ConstVectorImageIterator::SortRecord&, const ConstVectorImageIterator::SortRecord&);
int	CmpForHatchesFirst (const void*, const void*);


VI_DLL_EXPORT
//bool	CmpForSortQueue (const ConstVectorImageIterator::SortRecord&, const ConstVectorImageIterator::SortRecord&);
int	CmpForSortQueue (const void*, const void*);
