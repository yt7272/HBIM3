...
public:
	...
	Button (const Panel& panel, const Rect& rect, ButtonType type = RoundedEdge, FrameType frameType = Frame);
	~Button ();
...
public:
	...
	IconButton (const Panel& panel, const Rect& rect, ButtonForm form = RoundedEdge, FrameType frameType = Frame);
	~IconButton ();
...
public:
	...
	SplitButtonBase (const Panel& panel, const Rect& rect, DG::SplitButtonBase::ButtonForm type = DG::SplitButtonBase::RoundedEdge);
	~SplitButtonBase ();
...
public:
	...
	SplitButton (const Panel& panel, const Rect& rect, DG::SplitButton::ButtonForm type = DG::SplitButton::RoundedEdge);
	~SplitButton ();
...
public:
	...
	CustomSplitButton (const Panel& panel, const Rect& rect, DG::SplitButton::ButtonForm type = DG::SplitButton::RoundedEdge);
	~CustomSplitButton ();
