...
public:
	...
	UserControl (const Panel& panel, const Rect& rect, short procId, ButtonForm form = RoundedEdge);
	~UserControl ();

protected:
	UserControl (const Panel& panel, const Rect& rect, short procId, FrameType frameType, ButtonForm form = RoundedEdge);
