...
template <typename T>
class GS_EXPORT_TYPEINFO SingleValueUserData : public GS::Object
{
public:
	SingleValueUserData () = default;

	SingleValueUserData (const T& data)
		: data { data }
    {}

	SingleValueUserData (T&& data)
		: data { std::move (data) }
	{}

    virtual ~SingleValueUserData () override = default;
...
DG_DLL_EXPORT void CCALL		DGSetItemTextColor (short dialId, short item, UShort red, UShort green, UShort blue, UShort alpha = 0xFFFF);

DG_DLL_EXPORT bool CCALL		DGGetItemTextColor (short dialId, short item, UShort* red, UShort* green, UShort* blue, UShort* alpha = nullptr);
...
DG_DLL_EXPORT void CCALL		DGUserResetBackgroundColor (short dialId, short item);
...
DG_DLL_EXPORT void CCALL		DGListSetTabItemColor (short dialId, short item, short listItem, short tabIndex, UShort red, UShort green, UShort blue, UShort alpha = 0xFFFF);

DG_DLL_EXPORT bool CCALL		DGListGetTabItemColor (short dialId, short item, short listItem, short tabIndex, UShort* red, UShort* green, UShort* blue, UShort* alpha = nullptr);
...
DG_DLL_EXPORT void CCALL		DGListSetItemColor (short dialId, short item, short listItem, UShort red, UShort green, UShort blue, UShort alpha = 0xFFFF);

DG_DLL_EXPORT void CCALL		DGListResetItemColor (short dialId, short item, short listItem);

DG_DLL_EXPORT bool CCALL		DGListGetItemColor (short dialId, short item, short listItem, UShort* red, UShort* green, UShort* blue, UShort* alpha = nullptr);
...
DG_DLL_EXPORT void CCALL		DGListSetSeparatorLineColor (short dialId, short item, UShort red, UShort green, UShort blue, UShort alpha = 0xFFFF);

DG_DLL_EXPORT void CCALL		DGListGetSeparatorLineColor (short dialId, short item, UShort* red, UShort* green, UShort* blue, UShort* alpha = nullptr);
...
DG_DLL_EXPORT void CCALL		DGTreeViewSetItemTextColor (short dialId, short item, Int32 treeItem,
															UShort red, UShort green, UShort blue, UShort alpha = 0xFFFF);
...
DG_DLL_EXPORT bool CCALL		DGTreeViewGetItemTextColor (short dialId, short item, Int32 treeItem,
															UShort* red, UShort* green, UShort* blue, UShort* alpha = nullptr);
