...
private:
	...
	bool						dynamic;
	const ShortcutScheme*		alternativeShortcutScheme = nullptr;
...
public:
	...
	// constructors / destructors
				...
				MenuSimpleItem (CommandDescriptor* cmdDesc, const ShortcutScheme* alternativeShortcutScheme);
	...
	const Shortcut*			GetFirstActiveShortcut () const;
	const ShortcutScheme*	GetShortcutScheme () const;
