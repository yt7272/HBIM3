...
{
	char anchorStr[256];
	std::snprintf (anchorStr, sizeof (anchorStr), "CMD_%lu_0x%08lx_0x%08lx", (GS::ULongForStdio)commandId, (GS::ULongForStdio)developerId, (GS::ULongForStdio)productId);
...
{
	char buffer[128];
	std::snprintf (buffer, sizeof (buffer), "%lu-0x%08lx-0x%08lx", (GS::ULongForStdio)commandId, (GS::ULongForStdio)developerId, (GS::ULongForStdio)productId);
