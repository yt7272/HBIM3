...
private:
	...
	LearningContent::ILearnCenterController* learnCenterController;
...
public:
	...
	void									 SetLearnCenterController (LearningContent::ILearnCenterController* learnCenterController);
	LearningContent::ILearnCenterController* GetLearnCenterController (void);
	...
	virtual const CommandLayout*	GetWECommandLayout (void) const;
};
