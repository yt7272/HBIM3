...
GSErrCode GetGlobalIdManualProperty (API_Guid elemGuid, API_Guid globalIdManualDefGuid, GS::UniString& outGlobalId);
GSErrCode SetGlobalIdManualProperty (API_Guid elemGuid, API_Guid globalIdManualDefGuid, const GS::UniString& globalId);
